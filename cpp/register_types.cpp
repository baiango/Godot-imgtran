...
void initialize_imgtran_type(ModuleInitializationLevel p_level) {
	if (p_level != MODULE_INITIALIZATION_LEVEL_SCENE)
		return;
	ClassDB::register_class<Imgtran>();
}

void uninitialize_imgtran_type(ModuleInitializationLevel p_level) {
	if (p_level != MODULE_INITIALIZATION_LEVEL_SCENE)
		return;
}

// Unmangle function name in the symbol by compile as C
extern "C" {
